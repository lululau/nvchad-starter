...
map("i", "<D-S-i>", "<ESC>", { desc = "Enter Normal mode" })
...
map("n", "<leader>bR", "<ESC>:e!<CR>", { desc = "Revert buffer" })
map("n", "<leader>hc", "<cmd> NvCheatsheet <CR>", { desc = "Mapping cheatsheet" })
map("n", "<leader>qq", "<ESC>:qa!<CR>", { desc = "Force quit all" })
map("n", "<leader>qr", "<cmd>silent! wall | restart<CR>", { desc = "Restart (save all, restore session)" })
map("n", "<leader>qR", "<cmd>restart! +qall!<CR>", { desc = "Restart (force, discard all)" })
...
map("i", "<D-s>", "<C-o>:w<CR>", { desc = "save", nowait = true })
