...
map("n", "<S-CR>", function() vim.lsp.buf.references() end, { desc = "LSP references"})
...
map("n", "<c-x><c-o><c-b>", function() vim.lsp.buf.references() end, { desc = "LSP references"})
map("n", "<C-x>@sg", "<cmd> Neogit <CR>", { desc = "Open Neogit", silent = true})
...
map("i", "<S-CR>", function() vim.lsp.buf.references() end, { desc = "LSP references" })
...
map("i", "<c-x><c-o><c-b>", function() vim.lsp.buf.references() end, { desc = "LSP references" })
...
map("n", "<leader>gs", "<cmd> Neogit <CR>", { desc = "Git status" , nowait = true, silent = true })
map("n", "<D-g>", "<cmd> Neogit <CR>", { desc = "Git status" , nowait = true, silent = true })
